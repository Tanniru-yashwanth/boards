...
urlpatterns = [
    ...
    path("boards/<int:pk>/topics/<int:topic_pk>/post", views.PostListView.as_view(), name='topic_posts'),
    path("boards/<int:pk>/topics/<int:topic_pk>/post/edit", views.PostUpdateView.as_view(), name='edit_post'),
